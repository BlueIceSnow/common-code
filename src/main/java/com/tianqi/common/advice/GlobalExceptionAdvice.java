...
public class GlobalExceptionAdvice {
    ...
    public RestResult validateHandler(MethodArgumentNotValidException validateEx) {
    ...
    public RestResult jsonParseHandler(JsonMappingException jsonParseEx) {
    ...
    public RestResult baseException(BaseException baseException) {
        return RestResult.builder()
