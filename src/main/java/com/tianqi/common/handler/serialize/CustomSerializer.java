...
public class CustomSerializer {
     ...
     * status枚举序列化
     */
    public static class StatusSerializer extends JsonSerializer<StatusEnum> {
        @Override
        public void serialize(StatusEnum status, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
